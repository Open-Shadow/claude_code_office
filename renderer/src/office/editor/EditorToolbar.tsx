...
/** Maps furniture category ids to i18n keys under `editor.*` */
const CATEGORY_I18N_KEY: Record<string, string> = {
  desks: 'editor.desks',
  chairs: 'editor.chairs',
  storage: 'editor.storage',
  electronics: 'editor.tech',
  decor: 'editor.decor',
  wall: 'editor.wallCategory',
  misc: 'editor.misc',
};
    ...
    <div className="absolute bottom-76 left-10 z-10 pixel-panel p-4 flex flex-col-reverse gap-4 max-w-[calc(100vw-20px)]">
      ...
      <div className="flex gap-4 flex-wrap">
        <Button
          ...
          title={t('editorTools.placeFurniture')}
        >
          {t('editor.furniture')}
        </Button>
        <Button
          ...
          title={t('editorTools.paintFloor')}
        >
          {t('editor.floor')}
        </Button>
        <Button
        ...
        <div className="flex flex-col-reverse gap-4">
          ...
          <div className="flex gap-4 flex-wrap items-center">
            {getActiveCategories().map((cat) => (
              ...
              >
                {t(CATEGORY_I18N_KEY[cat.id] ?? cat.label)}
              </Button>
            ))}
