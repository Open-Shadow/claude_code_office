...
export interface FurnitureInstance {
  ...
  mirrored?: boolean;
  /** Furniture type ID (for type-based effects like plant breathing) */
  type?: string;
  /** Unique instance ID (for per-instance phase offsets) */
  uid?: string;
}
...
export interface Character {
  ...
  // -- Monitor NPC --
  /** Whether this character is the autonomous monitor NPC */
  isMonitorNpc?: boolean;
  /** Current NPC behavior: 'working' | 'reading' | 'wandering' | 'coffee' */
  npcBehavior?: string;
  /** Countdown timer for current NPC behavior (seconds) */
  npcBehaviorTimer?: number;
}
